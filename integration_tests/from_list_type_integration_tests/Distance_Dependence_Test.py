...
mapped_pop_1 = Population(pop_size,  # size
                          ...
                          structure=RandomStructure(
                              boundary=Sphere(radius=r_space),
                              rng=rng_positions),
                          label="mapped_pop_1")
...
inh_pop2 = Projection(pop_inhibit,
                      ...
                      DistanceDependentProbabilityConnector(
                          d_expression=connection_dependence % (
                          conn_prob_scale / conn_rate_ex_in, conn_char_dist),
                          weights=weight_dependence_i,
                          delays=delay_dependence),
                      target='inhibitory')
...
pop1_pop2 = Projection(mapped_pop_1,
                       ...
                       DistanceDependentProbabilityConnector(
                           d_expression=connection_dependence % (
                           conn_prob_scale, conn_char_dist),

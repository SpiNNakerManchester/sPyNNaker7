...
htmlhelp_basename = 'sPyNNaker7doc'
...
latex_documents = [
  ('index', 'sPyNNaker7.tex',
   u'sPyNNaker7 Documentation', u'', 'manual'),
]
...
texinfo_documents = [
  ('index', 'sPyNNaker7',
   u'sPyNNaker7 Documentation', u'', 'sPyNNaker', '',
   'Miscellaneous'),
]
